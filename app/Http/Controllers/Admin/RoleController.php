...
class RoleController extends Controller
{
    ...
    {
        $this->role = $this->role->withCount('permissions')->orderBy('id', 'ASC')->paginate();
    ...
    public function create()
    {
        ...
        return view('admin.roles.role-form', compact('permissions'));
    }
    ...
    public function edit($id)
    {
        ...
        $rolePermissions = DB::table("role_has_permissions")->where("role_has_permissions.role_id", $id)
            ...
            ->all();
        return view('admin.roles.role-form', compact('permissions', 'rolePermissions'))->with('role_data', $this->role);
    }
