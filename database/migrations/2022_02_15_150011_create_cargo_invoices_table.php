...
class CreateCargoInvoicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cargo_invoices', function (Blueprint $table) {
            $table->id();
            ...
            $table->tinyInteger('serviceId')->nullable();
            ...
            $table->foreign('referenceNumber')->on('cargo_invoices')->references('id')->cascadeOnDelete()->cascadeOnUpdate();
    ...
    {
        Schema::dropIfExists('cargo_invoices');
    }
}
