...
class RenameController extends LfmController
{
    public function getRename()
    {
        ...
        if ($old_file->hasThumb()) {
            // dd($this->helper->input('file'));
            // $images = $this->lfm->getImages($this->helper->input('file'));
            // dd($images);
            // if (count($images)) {
            //     foreach ($images as $old_thumb_name) {
            //         $this->lfm->setName($old_thumb_name)->thumb()
