...
<head>
  ...
  <style>{!! \File::get(base_path('packages/suryadeep/file-manager/public/css/lfm.css')) !!}</style>
...
<body>
  ...
  <script>{!! \File::get(base_path('packages/suryadeep/file-manager/public/js/script.js')) !!}</script>
