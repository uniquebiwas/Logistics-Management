                    ...
                    <div class="card card-primary">
                        <div class="card-body box-profile">
                            ...
                            {{-- <ul class="list-group list-group-unbordered mb-3">
                                ...
                                @canany(['advertisementposition-list', 'advertisementposition-create',
                                    'advertisementposition-edit', 'advertisementposition-delete', 'advertisement-list',
                            ...
                            <a href="{{ route('dashboard.index') }}" class="btn btn-primary btn-block"><b>View
                                    More</b></a> --}}
                        </div>
                    </div>
                </div>
                  ...
                  <div class="m-b-20">
                    ...
                    @endif
                            ...
                            <div class="col-md-12">
                                ...
                                <p class="text-sm">Ensure your account is using a long random password to stay
                                    secure.</p>
                                <hr>
                                <div class="m-0">
