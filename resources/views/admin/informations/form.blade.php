    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    @if ($information_info->id)
                        {!! Form::open(['url' => route('information.update', $information_info->id)]) !!}
                        @method('PATCH')
                    @else
                    ...
                    <div class="form-group row">
                        ...
                        {!! Form::text('title', $information_info->title, ['class' => 'form-control col-10 form-control-sm', 'placeholder' => 'title']) !!}
                        @error('title')
                    ...
                    <div class="form-group row">
                        ...
                        {!! Form::textarea('description', $information_info->description, ['class' => 'form-control col-10 form-control-sm', 'placeholder' => 'description']) !!}
                        @error('description')
                            <small id="helpId" class="text-danger col-12">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="form-group row {{ $errors->has('publish_status') ? 'has-error' : '' }}">
                        {{ Form::label('publish_status', 'Publish Status :*', ['class' => 'col-2']) }}
                        {{ Form::select('publish_status', [1 => 'Yes', 0 => 'No'], $information_info->publish_status, ['id' => 'publish_status', 'required' => true, 'class' => 'form-control col-10', 'style' => 'width:100%']) }}
                    ...
                    <div class="form-group row">
                        ...
                        <div id="holder" style="margin-top:15px;max-width: 60%;">
                            <img src="{{ $information_info->image }}" alt="" style="max-width: 100%">
                        </div>
