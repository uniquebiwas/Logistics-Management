                    ...
                    <tbody>
                        @foreach ($data as $key => $value)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('uploads/' . $value->img_path) }}"
                                ...
                                <td>
                                    <span
                                        class="badge badge-{{ $value->get_user->publish_status == '1' ? 'success' : 'danger' }}">
                                ...
                                <td>
                                    <div class="btn-group">
                                        @can('profile-edit')
                                            <a href="{{ route('profile.edit', $value->id) }}" title="Edit profile"
