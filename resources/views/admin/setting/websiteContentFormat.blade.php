...
@section('content')
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="btn-group btn-group-toggle col-md-6" data-toggle="buttons">
                                        <label
                                            class="btn btn-default   {{ @$appsetting->website_content_format == 'English' ? 'active' : '' }}">
                                        ...
                                        <label
                                            class="btn btn-default  {{ @$appsetting->website_content_format == 'Nepali' ? 'active' : '' }}">
                                            <input type="radio" name="website_content_format" autocomplete="off"
                                                value="Nepali"
                                                {{ @$appsetting->website_content_format == 'Nepali' ? 'checked' : '' }}>Nepali
                                        </label>
                                        <label
                                            class="btn btn-default  {{ @$appsetting->website_content_format == 'Both' ? 'active' : '' }}">
                                            <input type="radio" name="website_content_format" autocomplete="off"
                                                value="Both"
    ...
    <div class="card-footer">
        {{ Form::button("<i class='fa fa-paper-plane'></i> Save Seting", ['class' => 'global-btn', 'type' => 'submit']) }}
