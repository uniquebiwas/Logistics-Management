                ...
                <div class="card-body search-body">
                    ...
                    <div class="p-1 col-lg-4">
                        <div class="card-tools float-right">
                            @can('team-create')
                                <a href="{{ route('team.create') }}" class="global-btn">
                    ...
                    <tbody>
                        @foreach ($data as $key => $value)
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('uploads/team/thumbnail__' . @$value->image) }}"
                                ...
                                <td>
                                    <div class="btn-group">
                                        @can('team-edit')
                                            <a href="{{ route('team.edit', $value->id) }}" title="Edit Service"
                                                class="view-btn mr-1"><i class="fas fa-edit"></i></a>
                                        @endcan
                                        @can('team-delete')
                                            {{ Form::open(['method' => 'DELETE', 'route' => ['team.destroy', $value->id], 'style' => 'display:inline', 'onsubmit' => 'return confirm("Are you sure you want to delete this Service?")']) }}
                                            {{ Form::button('<i class="fas fa-trash-alt"></i>', ['class' => 'view-btn', 'type' => 'submit', 'title' => 'Delete team ']) }}
                                            {{ Form::close() }}
                                        @endcan
                                    </div>
                                </td>
