                        ...
                        <tbody>
                            @foreach ($data as $key => $value)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $value->url}}</td>
                                    <td><span class="{{ $value->origin == 'youtube' ? 'badge badge-danger' : 'badge badge-primary'}}">{{ $value->origin}}</span></td>
                                    <td> 
                                        <span class="{{  @$value->featured ? "badge badge-success" : "badge badge-error" }}">{{  @$value->featured ? "Yes" : "no" }}</span>
